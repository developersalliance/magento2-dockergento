...
FRONTEND_CONTAINER_ID=$(${DOCKER_COMPOSE} ps -q ${SERVICE_FRONTEND})
SYNC_NAME="dockergento_frontend"
CODE_SYNC_ALPHA="$(pwd -P)/$FRONTEND_HOST_DIR"
CODE_SYNC_BETA="docker://$FRONTEND_CONTAINER_ID$WORKDIR_FRONTEND/$FRONTEND_DIR"
